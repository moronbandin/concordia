...
const greekVerbPersons=["1.ª SG","2.ª SG","3.ª SG","1.ª PL","2.ª PL","3.ª PL"];
const greekVerbParadigms={
  lyo:{label:"λύω",enunciation:"λύω, λύσω, ἔλυσα, λέλυκα, λέλυμαι, ἐλύθην",meaning:"desatar",forms:{
    present:{active:["λύω","λύεις","λύει","λύομεν","λύετε","λύουσι(ν)"],middle:["λύομαι","λύῃ","λύεται","λυόμεθα","λύεσθε","λύονται"]},
    imperfect:{active:["ἔλυον","ἔλυες","ἔλυε(ν)","ἐλύομεν","ἐλύετε","ἔλυον"],middle:["ἐλυόμην","ἐλύου","ἐλύετο","ἐλυόμεθα","ἐλύεσθε","ἐλύοντο"]}
  }},
  ao:{label:"τιμάω",type:"-άω",meaning:"honrar",rule:"α + ε / ει → ᾱ · α + ο / ου → ω",forms:{
    present:{active:[["τιμά-ω","τιμῶ"],["τιμά-εις","τιμᾷς"],["τιμά-ει","τιμᾷ"],["τιμά-ομεν","τιμῶμεν"],["τιμά-ετε","τιμᾶτε"],["τιμά-ουσι(ν)","τιμῶσι(ν)"]],middle:[["τιμά-ομαι","τιμῶμαι"],["τιμά-ῃ","τιμᾷ"],["τιμά-εται","τιμᾶται"],["τιμα-όμεθα","τιμώμεθα"],["τιμά-εσθε","τιμᾶσθε"],["τιμά-ονται","τιμῶνται"]]},
    imperfect:{active:[["ἐτίμα-ον","ἐτίμων"],["ἐτίμα-ες","ἐτίμας"],["ἐτίμα-ε","ἐτίμα"],["ἐτιμά-ομεν","ἐτιμῶμεν"],["ἐτιμά-ετε","ἐτιμᾶτε"],["ἐτίμα-ον","ἐτίμων"]],middle:[["ἐτιμα-όμην","ἐτιμώμην"],["ἐτιμά-ου","ἐτιμῶ"],["ἐτιμά-ετο","ἐτιμᾶτο"],["ἐτιμα-όμεθα","ἐτιμώμεθα"],["ἐτιμά-εσθε","ἐτιμᾶσθε"],["ἐτιμά-οντο","ἐτιμῶντο"]]}
  }},
  eo:{label:"ποιέω",type:"-έω",meaning:"facer",rule:"ε + ε / ει → ει · ε + ο / ου → ου",forms:{
    present:{active:[["ποιέ-ω","ποιῶ"],["ποιέ-εις","ποιεῖς"],["ποιέ-ει","ποιεῖ"],["ποιέ-ομεν","ποιοῦμεν"],["ποιέ-ετε","ποιεῖτε"],["ποιέ-ουσι(ν)","ποιοῦσι(ν)"]],middle:[["ποιέ-ομαι","ποιοῦμαι"],["ποιέ-ῃ","ποιεῖ"],["ποιέ-εται","ποιεῖται"],["ποιε-όμεθα","ποιούμεθα"],["ποιέ-εσθε","ποιεῖσθε"],["ποιέ-ονται","ποιοῦνται"]]},
    imperfect:{active:[["ἐποίε-ον","ἐποίουν"],["ἐποίε-ες","ἐποίεις"],["ἐποίε-ε","ἐποίει"],["ἐποιέ-ομεν","ἐποιοῦμεν"],["ἐποιέ-ετε","ἐποιεῖτε"],["ἐποίε-ον","ἐποίουν"]],middle:[["ἐποιε-όμην","ἐποιούμην"],["ἐποιέ-ου","ἐποιοῦ"],["ἐποιέ-ετο","ἐποιεῖτο"],["ἐποιε-όμεθα","ἐποιούμεθα"],["ἐποιέ-εσθε","ἐποιεῖσθε"],["ἐποιέ-οντο","ἐποιοῦντο"]]}
  }},
  oo:{label:"δηλόω",type:"-όω",meaning:"mostrar",rule:"ο + ε / ει → οι · ο + ο / ου → ου",forms:{
    present:{active:[["δηλό-ω","δηλῶ"],["δηλό-εις","δηλοῖς"],["δηλό-ει","δηλοῖ"],["δηλό-ομεν","δηλοῦμεν"],["δηλό-ετε","δηλοῦτε"],["δηλό-ουσι(ν)","δηλοῦσι(ν)"]],middle:[["δηλό-ομαι","δηλοῦμαι"],["δηλό-ῃ","δηλοῖ"],["δηλό-εται","δηλοῦται"],["δηλο-όμεθα","δηλούμεθα"],["δηλό-εσθε","δηλοῦσθε"],["δηλό-ονται","δηλοῦνται"]]},
    imperfect:{active:[["ἐδήλο-ον","ἐδήλουν"],["ἐδήλο-ες","ἐδήλους"],["ἐδήλο-ε","ἐδήλου"],["ἐδηλό-ομεν","ἐδηλοῦμεν"],["ἐδηλό-ετε","ἐδηλοῦτε"],["ἐδήλο-ον","ἐδήλουν"]],middle:[["ἐδηλο-όμην","ἐδηλούμην"],["ἐδηλό-ου","ἐδηλοῦ"],["ἐδηλό-ετο","ἐδηλοῦτο"],["ἐδηλο-όμεθα","ἐδηλούμεθα"],["ἐδηλό-εσθε","ἐδηλοῦσθε"],["ἐδηλό-οντο","ἐδηλοῦντο"]]}
  }}
};
